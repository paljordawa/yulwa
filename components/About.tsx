        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="about-visual w-full lg:w-1/2 flex justify-center">
            <div className="relative">
              ...
              <div className="badge-float-1 absolute -top-4 -left-4 text-emerald-400 rotate-12">
                <Box className="w-6 h-6" />
              </div>
              <div className="badge-float-2 absolute bottom-10 -left-6 text-teal-400 -rotate-12">
